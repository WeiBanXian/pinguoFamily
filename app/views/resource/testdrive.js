//******************************************************************************
//	name:	SGM Chevy testdrive 1.7.7
//	author:	wally
...
//				v1.7.4 _onSuccess方法里的两行代码调整顺序
//				v1.7.5 可定义isdown参数
//				v1.7.6 getQueryString方法换了代码, 及暴露unserialize方法
//				v1.7.7 增加科沃兹车型, 车型map值有调整
//
//				提供的方法如下：
...
(function (hy, $jq) {
	...
	function _init(){
		...
		var qsOldObj = unserialize(_getCookie("utmc_chevy")) || {};
	...
	function _onSuccess(paramObj, data, completeFn){
		...
		if(!cbResult && data.status=="suc"){//当_completeFn返回值为false时，会执行以下代码，当返回值为true时，跳过以下代码执行
			...
			if(hylink.trackPV){
            	if(data.leadId!="") hylink.trackLeads(paramObj.name, paramObj.mobile, data.leadId, paramObj);
	...
	function _parseParamObj(value, exParams){
		...
		if(typeof(exParams)=="string"){
			...
			var params = ["email", "dealer", "province", "city", "source", "campaign", "medium", "term", "content","isdown"];
	...
	function carList(value){
		var obj =  {"科帕奇":"captiva", "赛欧3":"sail", "科迈罗":"camaro","第六代科迈罗":"camaro6", "全新科鲁兹":"cruze", "经典科鲁兹":"cruze-classic", "科鲁兹掀背车":"cruze-liftback", 
			...
			"赛欧SPRINGO纯电动车":"sail","赛欧RV":"sail","E17":"E17","赛欧":"sail", "斯帕可":"spark", "迈锐宝":"malibu", "全新迈锐宝":"malibu", "迈锐宝XL":"malibuXL","科沃兹":"cavalier"};
	...
	function _carEnNameMap(value){
		var obj =  {"乐风 RV":"lovarv","科帕奇":"captiva", "赛欧3":"sail", "科迈罗":"camaro","第六代科迈罗":"camaro6","全新科鲁兹":"cruze", "经典科鲁兹":"cruze-classic", 
				"科鲁兹掀背车":"cruze-liftback", "迈锐宝":"malibu","迈锐宝XL":"malibuXL","创酷":"trax","爱唯欧":"aveo","爱唯欧两厢":"aveo-hb", "爱唯欧三厢":"aveo-nb","科沃兹":"cavalier"};
		if(value!=null && typeof(value)=="string" && value!=""){
			return obj[value];
		}else if(arguments.length==0){
			return obj;
	...
	function _carCnNameMap(value){
		var obj = {"lovarv":"乐风 RV","captiva":"科帕奇","sail":"赛欧3","camaro":"科迈罗","camaro6":"第六代科迈罗","cruze":"全新科鲁兹","new-cruze":"全新科鲁兹","cruze-classic":"经典科鲁兹",
				"cruze-liftback":"科鲁兹掀背车","malibu":"迈锐宝", "malibuXL":"迈锐宝XL","malibu-xl":"迈锐宝XL","trax":"创酷","aveo":"爱唯欧","aveo-hb":"爱唯欧两厢","aveo-nb":"爱唯欧三厢","cavalier":"科沃兹"};
		if(value!=null && typeof(value)=="string" && value!=""){
			return obj[value];
		}else if(arguments.length==0){
			return obj;
